...
const translations: Record<Locale, Record<string, string>> = {
  ca: {
    ...
    'chat.send': 'Enviar',
    'chat.disabledProduction': '⚠️ El xat en temps real no està disponible a producció. Socket.io requereix configuració addicional.',
    'chat.today': 'Avui',
    'chat.yesterday': 'Ahir',
  ...
  es: {
    ...
    'chat.send': 'Enviar',
    'chat.disabledProduction': '⚠️ El chat en tiempo real no está disponible en producción. Socket.io requiere configuración adicional.',
    'chat.today': 'Hoy',
    'chat.yesterday': 'Ayer',
    'chat.dateSeparator': '{date}',
  },
  en: {
    ...
    'chat.send': 'Send',
    'chat.disabledProduction': '⚠️ Real-time chat is not available in production. Socket.io requires additional configuration.',
    'chat.today': 'Today',
