...
const translations: Record<Locale, Record<string, string>> = {
  ca: {
    ...
    'info.intro': 'La Xarxa Anglesola és un espai de trobada de la comunitat de l\'escola per compartir recursos i donar-nos un cop de mà. Descobreix tot el que hi pots fer:',
    'info.productsTitle': '📦 Veure productes',
    'info.productsDesc': 'Fes una ullada al que la gent posa a disposició. Bicis, llibres, eines... el que necessitis!',
    'info.favoritesTitle': '❤️ Guardar als preferits',
    'info.favoritesDesc': 'Si alguna cosa et fa gràcia, afegeix-la als preferits per trobar-la després sense perdre-la.',
    ...
    'info.reserveDesc': 'Hi ha alguna cosa que t\'hagi cridat l\'atenció? Reserva-la i contacta amb qui la publica per quedar.',
    ...
    'info.reserveType1Desc': 'Prem el botó reservar, així quedarà inhabilitada per a d\'altres reserves i en el cas que sigui un producte que només sigui per a préstecs, podràs canviar-ne l\'estat quan sigui necessari.',
    'info.reserveType1DescBefore': 'Prem el botó ',
    'info.reserveType1DescAfter': ', així quedarà inhabilitada per a d\'altres reserves i en el cas que sigui un producte que només sigui per a préstecs, podràs canviar-ne l\'estat quan sigui necessari.',
    'info.reserveType2Title': 'Reserva per DM',
    'info.reserveType2Desc': 'Si obres el xat privat d\'un producte, el reserves automàticament (el primer que obre el xat és qui reserva). Si veus que la fotografia té un marc groc, significa que l\'has reservat tu, si només té la icona en groc, l\'ha reservat una altra persona.',
    ...
    'products.unreserved': 'Finalitzar la reserva',
    ...
    'products.unreserveTitle': 'Finalitzar la reserva',
    ...
    'notifications.productUnreserved': 'Finalitzada la reserva',
    'notifications.productUnreservedMessage': '{nickname} ha finalitzat la reserva del teu producte: {productName}',
    'notifications.productUnreservedFromFavorites': 'Finalitzada la reserva',
    'notifications.productUnreservedFromFavoritesMessage': '{nickname} ha finalitzat la reserva d\'un producte dels teus preferits: {productName}',
  ...
  es: {
    ...
    'info.title': '¿Cómo funciona la Xarxa?',
    'info.intro': 'La Xarxa Anglesola es un espacio para compartir y pedir cosas en préstamo entre padres y madres del colegio Anglesola. Aquí tienes todo lo que puedes hacer:',
    ...
    'info.myProductsDesc': '¿Tienes algo que no usas? ¡Publícalo!',
    'info.reserveTitle': '📌 Reservar',
    'info.reserveDesc': '¿Hay algo que te haya llamado la atención? Resérvalo y contacta con quien lo publicó para quedar.',
    ...
    'info.reserveType1Desc': 'Pulsa el botón reservar, así quedará inhabilitado para otras reservas y en el caso de que sea un producto solo para préstamos, podrás cambiar su estado cuando sea necesario.',
    'info.reserveType1DescBefore': 'Pulsa el botón ',
    'info.reserveType1DescAfter': ', así quedará inhabilitado para otras reservas y en el caso de que sea un producto solo para préstamos, podrás cambiar su estado cuando sea necesario.',
    'info.reserveType2Title': 'Reserva por DM',
    'info.reserveType2Desc': 'Si abres el chat privado de un producto, lo reservas automáticamente (el primero que abre el chat es quien reserva). Si ves que la fotografía tiene un marco amarillo, significa que lo has reservado tú; si solo tiene el icono en amarillo, lo ha reservado otra persona.',
    ...
    'info.notificationsDesc': 'Activa las alertas en la campana para saber cuando te reservan algún producto, te escriben o hay algún cambio en tus favoritos.',
