...
const translations: Record<Locale, Record<string, string>> = {
  ca: {
    ...
    'info.intro': 'La Xarxa Anglesola és un espai per compartir i demanar coses en préstec entre pares i mares de l\'escola Anglesola. Aquí tens tot el que pots fer:',
    ...
    'info.reserveType2Title': 'Reserva obrint un DM',
    'info.reserveType2Desc': 'Si obres el xat privat d\'un producte, el reserves automàticament (el primer que obre el xat és qui reserva). Ideal per no perdre el torn. Si veus que la fotografia té un marc groc, significa que l\'has reservat tu, si només té la icona en groc, l\'ha reservat una altra persona.',
  ...
  es: {
    ...
    'info.reserveType2Title': 'Reserva abriendo un DM',
    'info.reserveType2Desc': 'Si abres el chat privado de un producto, lo reservas automáticamente (el primero que abre el chat es quien reserva). Ideal para no perder el turno. Si ves que la fotografía tiene un marco amarillo, significa que lo has reservado tú; si solo tiene el icono en amarillo, lo ha reservado otra persona.',
  ...
  en: {
    ...
    'info.reserveType2Title': 'Reserve by opening a DM',
    'info.reserveType2Desc': 'If you open the private chat for a product, you reserve it automatically (the first to open the chat gets the reserve). Ideal for not losing your turn. If the photo has a yellow frame, you reserved it; if it only has the yellow icon, someone else reserved it.',
    'info.chatTitle': '💬 Chat',
