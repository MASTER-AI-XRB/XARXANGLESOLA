...
const translations: Record<Locale, Record<string, string>> = {
  ca: {
    ...
    'config.unlinkGoogleConfirm': 'Vols desvincular el compte de Google? Podràs tornar a vincular-lo iniciant sessió amb Google.',
  ...
  es: {
    ...
    'config.unlinkGoogleConfirm': '¿Quieres desvincular la cuenta de Google? Podrás volver a vincularla iniciando sesión con Google.',
  ...
  en: {
    ...
    'config.unlinkGoogleConfirm': 'Unlink your Google account? You can link it again by signing in with Google.',
