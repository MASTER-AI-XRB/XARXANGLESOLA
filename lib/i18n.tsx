...
const translations: Record<Locale, Record<string, string>> = {
  ca: {
    ...
    'auth.accountNotLinked': 'Has desvinculat aquest compte de Google. Inicia sessió amb usuari i contrasenya.',
    'auth.acceptTerms': 'Accepto la',
    'auth.privacyPolicy': 'Política de Privacitat',
    'auth.and': 'i els',
    'auth.termsConditions': 'Termes i Condicions',
    'auth.mustAccept': 'Has d\'acceptar la política de privacitat i els termes i condicions per registrar-te',
    ...
    'info.intro': 'La Xarxa Anglesola és un espai per compartir i demanar coses en préstec entre veïns. Aquí tens tot el que pots fer:',
    'info.productsTitle': '📦 Veure productes',
    'info.productsDesc': 'Fes una ullada al que la gent posa a la disposició. Bicis, llibres, eines... el que necessitis!',
    'info.favoritesTitle': '❤️ Guardar als preferits',
    'info.favoritesDesc': 'Si alguna cosa et fa gràcia, afegir-la als preferits per trobar-la després sense perdre-la.',
    'info.myProductsTitle': '✨ Publicar els teus',
    'info.myProductsDesc': 'Tens alguna cosa que no fas servir? Publica-la! Així altres poden demanar-la en préstec.',
    'info.reserveTitle': '📌 Reservar',
    'info.reserveDesc': 'Vols agafar alguna cosa en préstec? Reserva-la i contacta amb qui la publica per quedar.',
    'info.reserveMoreDetails': 'Més detalls',
    'info.reserveDetailTitle': 'Tipus de reserves',
    'info.reserveDetailIntro': 'Hi ha dues maneres de reservar un producte a la Xarxa:',
    'info.reserveType1Title': 'Reserva des de la fitxa del producte',
    'info.reserveType1Desc': 'A la pàgina del producte, prem el botó «Reservar». El producte quedarà reservat per tu i podràs contactar qui el publica per quedar.',
    'info.reserveType2Title': 'Reserva en obrir el xat',
    'info.reserveType2Desc': 'Si obres el xat privat d\'un producte, et reserves automàticament (el primer que obre el xat és qui reserva). Ideal per no perdre el torn.',
    'info.chatTitle': '💬 Xatejar',
    'info.chatDesc': 'Parlar al xat general o en privat amb qui publica un producte. Ideal per coordinar lliuraments.',
    'info.notificationsTitle': '🔔 Notificacions',
    'info.notificationsDesc': 'Activa les alertes a la campana per saber quan et reserven algo, et escriuen o afegen als preferits.',
    'info.settingsTitle': '⚙️ Configuració',
    'info.settingsDesc': 'Des d\'aquí gestiones el teu compte, les preferències de notificacions i les teves dades.',
    'config.title': 'Configuració',
    'config.account': 'Compte',
    'config.unlinkGoogle': 'Desvincula Google',
    'config.unlinkGoogleConfirm': 'Vols desvincular el compte de Google? A partir d\'ara hauràs d\'iniciar sessió amb usuari i contrasenya.',
    ...
    'config.changeGoogleConfirm': 'Es farà logout i s\'obrirà Google per triar un altre compte. Vols continuar?',
    ...
    'notifications.notificationsEnabledMessage': 'Ara rebràs notificacions del navegador.',
    'notifications.notificationsDisabled': 'Notificacions desactivades',
    'notifications.notificationsDisabledMessage': 'Has denegat els permisos de notificació. Pots activar-les des de la configuració del navegador.',
    ...
    'notifications.disableInstructionsMessage': 'Per desactivar les notificacions, ves a la configuració del teu navegador i bloqueja els permisos de notificació per a aquest lloc web.',
    'notifications.preferencesTitle': 'Preferències de notificacions',
    ...
    'notifications.savePreferences': 'Desar preferències',
    'notifications.preferencesSaved': 'Preferències desades',
    'notifications.preferencesError': 'No s\'han pogut desar les preferències',
    'notifications.preferencesLoading': 'Carregant preferències...',
    'config.gdpr.title': 'Protecció de dades (GDPR)',
    'config.gdpr.exportDescription': 'Descàrrega una còpia de totes les teves dades personals en format JSON.',
    'config.gdpr.deleteDescription': 'Elimina permanentment el teu compte i totes les teves dades. Aquesta acció no es pot desfer.',
    'legal.privacy.title': 'Política de Privacitat',
    'legal.privacy.lastUpdated': 'Última actualització',
    'legal.privacy.section1.title': '1. Introducció',
    'legal.privacy.section1.content': 'Aquesta Política de Privacitat descriu com recopilem, utilitzem i protegim la teva informació personal quan utilitzes la plataforma Xarxa Anglesola. Ens comprometem a protegir la teva privacitat i complir amb la normativa de protecció de dades aplicable.',
    'legal.privacy.section2.title': '2. Dades que recopilem',
    'legal.privacy.section2.item1': 'Dades d\'identificació: nickname, email, nom (opcional)',
    'legal.privacy.section2.item2': 'Dades d\'autenticació: contrasenya encriptada, tokens de sessió',
    'legal.privacy.section2.item3': 'Contingut generat: productes publicats, missatges de xat, llista de preferits',
    'legal.privacy.section2.item4': 'Dades de comportament: preferències de notificació, activitat a la plataforma',
    'legal.privacy.section2.item5': 'Dades tècniques: adreça IP, cookies, informació del dispositiu',
    'legal.privacy.section3.title': '3. Finalitat del tractament',
    'legal.privacy.section3.content': 'Utilitzem les teves dades per: proporcionar i millorar els nostres serveis, gestionar el teu compte, facilitar la comunicació entre usuaris, enviar notificacions rellevants, garantir la seguretat de la plataforma i complir amb obligacions legals.',
    'legal.privacy.section4.title': '4. Base legal',
    'legal.privacy.section4.content': 'El tractament de les teves dades es basa en: el teu consentiment, l\'execució d\'un contracte (prestació del servei), l\'interès legítim (seguretat i millora del servei) i el compliment d\'obligacions legals.',
    'legal.privacy.section5.title': '5. Els teus drets',
    'legal.privacy.section5.content': 'D\'acord amb el Reglament General de Protecció de Dades (RGPD), tens dret a:',
    'legal.privacy.section5.right1': 'Accés: obtenir una còpia de les teves dades personals',
    'legal.privacy.section5.right2': 'Rectificació: corregir dades inexactes o incompletes',
    'legal.privacy.section5.right3': 'Supressió: sol·licitar l\'eliminació de les teves dades',
    'legal.privacy.section5.right4': 'Portabilitat: rebre les teves dades en un format estructurat',
    'legal.privacy.section5.right5': 'Oposició: oposar-te al tractament de les teves dades en determinades circumstàncies',
    'legal.privacy.section6.title': '6. Retenció de dades',
    'legal.privacy.section6.content': 'Conservem les teves dades mentre el teu compte estigui actiu i durant el període necessari per complir amb obligacions legals. Pots eliminar el teu compte en qualsevol moment des de la configuració.',
    'legal.privacy.section7.title': '7. Seguretat',
    'legal.privacy.section7.content': 'Implementem mesures de seguretat tècniques i organitzatives per protegir les teves dades contra accés no autoritzat, pèrdua o destrucció. Les contrasenyes s\'emmagatzemen encriptades i utilitzem connexions segures (HTTPS).',
    'legal.privacy.section8.title': '8. Contacte',
    'legal.privacy.section8.content': 'Per exercir els teus drets o fer consultes sobre privacitat, pots contactar-nos a través de la configuració del teu compte o utilitzant les funcionalitats de gestió de dades disponibles a la plataforma.',
    'legal.terms.title': 'Termes i Condicions',
    'legal.terms.lastUpdated': 'Última actualització',
    'legal.terms.section1.title': '1. Acceptació dels termes',
    'legal.terms.section1.content': 'En utilitzar la plataforma Xarxa Anglesola, acceptes aquests Termes i Condicions. Si no estàs d\'acord, no utilitzis el servei.',
    'legal.terms.section2.title': '2. Ús del servei',
    'legal.terms.section2.content': 'Et compromets a utilitzar la plataforma de manera lícita i respectuosa. No pots utilitzar el servei per activitats il·legals, fraudulentes o que violin drets de tercers.',
    ...
    'legal.terms.section4.content': 'Els usuaris conserven els drets sobre el contingut que publiquen. En publicar contingut, ens atorgues una llicència per utilitzar-lo dins de la plataforma per a la prestació del servei.',
    'legal.terms.section5.title': '5. Limitació de responsabilitat',
    'legal.terms.section5.content': 'La plataforma es proporciona \'tal com està\'. No ens responsabilitzem de danys directes, indirectes o conseqüencials derivats de l\'ús del servei. Els intercanvis entre usuaris són responsabilitat dels usuaris.',
    'legal.terms.section6.title': '6. Modificacions',
    'legal.terms.section6.content': 'Ens reservem el dret de modificar aquests termes en qualsevol moment. Les modificacions entraràn en vigor quan es publiquin a la plataforma. L\'ús continuat del servei després de les modificacions implica l\'acceptació dels nous termes.',
    'legal.terms.section7.title': '7. Resolució de conflictes',
    'legal.terms.section7.content': 'Qualsevol disputa relacionada amb l\'ús de la plataforma es regirà per la legislació espanyola i catalana. Els usuaris es comprometen a intentar resoldre els conflictes de manera amistosa abans de recórrer a accions legals.',
    'legal.cookies.message': 'Aquest lloc web utilitza cookies per millorar l\'experiència d\'usuari i proporcionar funcionalitats essencials.',
    'legal.cookies.learnMore': 'Més informació',
    ...
    'legal.gdpr.deleteConfirm': 'Estàs segur que vols eliminar el teu compte? Aquesta acció no es pot desfer.',
  ...
  es: {
    ...
    'auth.accountNotLinked': 'Has desvinculado esta cuenta de Google. Inicia sesión con usuario y contraseña.',
    'auth.acceptTerms': 'Acepto la',
    'auth.privacyPolicy': 'Política de Privacidad',
    'auth.and': 'y los',
    'auth.termsConditions': 'Términos y Condiciones',
    'auth.mustAccept': 'Debes aceptar la política de privacidad y los términos y condiciones para registrarte',
    ...
    'info.title': '¿Cómo funciona la Red?',
    'info.intro': 'La Xarxa Anglesola es un espacio para compartir y pedir cosas en préstamo entre vecinos. Aquí tienes todo lo que puedes hacer:',
    'info.productsTitle': '📦 Ver productos',
    'info.productsDesc': 'Echa un vistazo a lo que la gente pone a disposición. Bicis, libros, herramientas... ¡lo que necesites!',
    'info.favoritesTitle': '❤️ Guardar en favoritos',
    'info.favoritesDesc': '¿Algo te hace gracia? Añádelo a favoritos para encontrarlo después sin perderlo.',
    'info.myProductsTitle': '✨ Publicar los tuyos',
    'info.myProductsDesc': '¿Tienes algo que no usas? ¡Publícalo! Así otros pueden pedírtelo en préstamo.',
    'info.reserveTitle': '📌 Reservar',
    'info.reserveDesc': '¿Quieres coger algo en préstamo? Resérvalo y contacta con quien lo publicó para quedar.',
    'info.reserveMoreDetails': 'Más detalles',
    'info.reserveDetailTitle': 'Tipos de reserva',
    'info.reserveDetailIntro': 'Hay dos formas de reservar un producto en la Red:',
    'info.reserveType1Title': 'Reserva desde la ficha del producto',
    'info.reserveType1Desc': 'En la página del producto, pulsa el botón «Reservar». El producto quedará reservado para ti y podrás contactar con quien lo publica para quedar.',
    'info.reserveType2Title': 'Reserva al abrir el chat',
    'info.reserveType2Desc': 'Si abres el chat privado de un producto, te reservas automáticamente (el primero que abre el chat es quien reserva). Ideal para no perder el turno.',
    'info.chatTitle': '💬 Chatear',
    'info.chatDesc': 'Hablar en el chat general o en privado con quien publica un producto. Ideal para coordinar entregas.',
    'info.notificationsTitle': '🔔 Notificaciones',
    'info.notificationsDesc': 'Activa las alertas en la campana para saber cuando te reservan algo, te escriben o añaden a favoritos.',
    'info.settingsTitle': '⚙️ Configuración',
    'info.settingsDesc': 'Desde aquí gestionas tu cuenta, las preferencias de notificaciones y tus datos.',
    'config.title': 'Configuración',
    'config.account': 'Cuenta',
    'config.unlinkGoogle': 'Desvincular Google',
    'config.unlinkGoogleConfirm': '¿Quieres desvincular la cuenta de Google? Se cerrará sesión al instante. Para volver a entrar, usa el formulario (registro o login) o Continuar con Google.',
    ...
    'config.changeGoogleConfirm': 'Se cerrará sesión y se abrirá Google para elegir otra cuenta. ¿Continuar?',
    ...
    'notifications.notificationsEnabledMessage': 'Ahora recibirás notificaciones del navegador.',
    'notifications.notificationsDisabled': 'Notificaciones desactivadas',
    'notifications.notificationsDisabledMessage': 'Has denegado los permisos de notificación. Puedes activarlas desde la configuración del navegador.',
    ...
    'notifications.disableInstructionsMessage': 'Para desactivar las notificaciones, ve a la configuración del navegador y bloquea los permisos de notificación para este sitio web.',
  ...
  en: {
    ...
    'info.title': 'How does the Network work?',
    'info.intro': 'Xarxa Anglesola is a space to share and borrow things between neighbours. Here\'s everything you can do:',
    'info.productsTitle': '📦 Browse products',
    'info.productsDesc': 'Take a look at what people are sharing. Bikes, books, tools... whatever you need!',
    'info.favoritesTitle': '❤️ Save to favourites',
    'info.favoritesDesc': 'See something you like? Add it to your favourites so you can find it later without losing it.',
    'info.myProductsTitle': '✨ Publish yours',
    'info.myProductsDesc': 'Got something you don\'t use? Publish it! Others can borrow it from you.',
    'info.reserveTitle': '📌 Reserve',
    'info.reserveDesc': 'Want to borrow something? Reserve it and get in touch with the person who published it to arrange a handover.',
    ...
    'info.reserveType1Title': 'Reserve from the product page',
    'info.reserveType1Desc': 'On the product page, tap the «Reserve» button. The product will be reserved for you and you can contact the publisher to arrange a handover.',
    'info.reserveType2Title': 'Reserve when opening the chat',
    'info.reserveType2Desc': 'If you open the private chat for a product, you reserve it automatically (the first to open the chat gets the reserve). Ideal for not losing your turn.',
    'info.chatTitle': '💬 Chat',
    ...
    'info.notificationsTitle': '🔔 Notifications',
    'info.notificationsDesc': 'Turn on alerts in the bell icon to know when someone reserves your item, messages you, or adds it to their favourites.',
    'info.settingsTitle': '⚙️ Settings',
